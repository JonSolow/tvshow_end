...
1. Create a an empty repository (no License or README) on github with the name tvshow_end.git.
2. Push the local repo to github. From within the root directory of your local project execute the following:

```
  git remote add origin https://github.com/(Your Github UserName Here)/tvshow_end.git
